...
// 分表
class SqlsrvShardDbTest extends ShardDbTest
{
    ...
    protected function setUp()
    {
        ...
        static::execSqlsrvSql('hehe_test0','sqlsrv_shard_db.sql',"0");
        static::execSqlsrvSql('hehe_test1','sqlsrv_shard_db.sql',"1");
        static::execSqlsrvSql('hehe_test2','sqlsrv_shard_db.sql',"2");
    }
